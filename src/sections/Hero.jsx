...
function Hero({ folderRef, isFolderOpen, getFolderSize, onFolderInteract }) {
  ...
  return (
    <main className="content container mx-auto flex-grow min-h-screen flex flex-col gap-6 mobile:gap-6 tablet:gap-8 laptop:gap-10 desktop:gap-20 laptop:grid laptop:grid-cols-[1fr_auto_1fr] items-center laptop:items-end justify-between px-4 mobile:px-6 laptop:px-10 desktop-lg:px-[100px] relative overflow-hidden pt-16 mobile:pt-20 tablet:pt-24 laptop:pt-0" style={{paddingBottom: 0}}>
      ...
      {/* Coluna 3 – About me */}
      <div className="order-3 relative z-10 laptop:self-end laptop:mb-[60px] laptop:justify-self-end">
